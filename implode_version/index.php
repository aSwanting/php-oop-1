...
//     var_dump($prod->print_properties());
// }
                    ...
                    <div class="card grid-item shadow">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <?= implode(array_map(
                                    function ($value, $key) {
                                        return "<li class='list-group-item'><span class='fw-medium'>{$key}: </span>{$value}</li>";
                                    },
                                    (array)$prod->print_properties(),
                                    array_keys((array)$prod->print_properties())
                                )); ?>
